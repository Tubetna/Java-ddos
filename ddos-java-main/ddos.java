...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Chủ đề chính kết thúc.");
    }
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Đã kết nối với Web ngu");
        }
        Dos.url = url;
    }
    ...
    private void sslCheckConnection(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        if (responseCode == 200) {
            System.out.println("Đã kết nối với với Web ngu");
        }
        Dos.url = url;
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Tấn công hoàn tất!: " + responseCode + "Thread: " + this.seq);
    }
